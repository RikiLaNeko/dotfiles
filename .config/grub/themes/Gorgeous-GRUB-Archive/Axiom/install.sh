...
# This script installs the GRUB2  devuan-dark theme in /boot/grub/themes/, /boot/grub2/themes/ or /grub/themes/
# depending on the distribution.
#
# Theme Author: Anto Fox
# The original script was writter by  Towheed Mohammed Copyright (C) 2011 GPL3
...
# Set variables
Theme_Name="devuan-dark"			# The theme will be installed in a dir with this name. Avoid spaces.
